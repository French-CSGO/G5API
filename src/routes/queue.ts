...
router.get("/:slug", async (req, res) => {
  ...
  try {
    ...
    console.error("Error fetching queue:", String(error).replace(/[\r\n]/g, " "));
...
router.get("/:slug/players", Utils.ensureAuthenticated, async (req, res) => {
  ...
  try {
    ...
    console.error("Error listing players in queue:", String(error).replace(/[\r\n]/g, " "));
...
router.put("/:slug", Utils.ensureAuthenticated, async (req, res) => {
  ...
  try {
    ...
    console.error(`Error processing ${String(action).replace(/[\r\n]/g, " ")} for queue ${String(slug).replace(/[\r\n]/g, " ")}:`, String(error).replace(/[\r\n]/g, " "));
...
router.put("/:slug/teams", Utils.ensureAuthenticated, async (req, res) => {
  ...
  try {
    ...
    console.error("Error setting queue teams:", String(error).replace(/[\r\n]/g, " "));
...
router.post("/:slug/start", Utils.ensureAuthenticated, async (req, res) => {
  ...
  try {
    ...
    console.error("Error starting manual queue:", String(error).replace(/[\r\n]/g, " "));
...
router.delete("/", Utils.ensureAuthenticated, async (req, res) => {
  ...
  try {
    ...
    console.error("Error deleting queue:", String(error).replace(/[\r\n]/g, " "));
